...
class TestGamepassCli(GamepassTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `gamepass-cli getinfo`")
        ...
        self.log.info("Compare responses from `gamepass-cli -getinfo` and the RPCs data is retrieved from.")
