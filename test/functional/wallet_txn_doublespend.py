...
class TxnMallTest(GamepassTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 GPN:
        ...
        # First: use raw transaction API to send 1240 GPN to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 GPN coin each
        ...
        # Node0's balance should be starting balance, plus 50GPN for another
        ...
        # Node0's total balance should be starting balance, plus 100GPN for 
