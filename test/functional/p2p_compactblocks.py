...
# TestNode: A peer we use to send messages to gamepassd, and store responses.
...
class CompactBlocksTest(GamepassTestFramework):
    ...
    # This test actually causes gamepassd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that gamepassd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for gamepassd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # gamepassd will not send blocktxn responses for blocks whose height is
