...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the GamepassTestFramework
    pass

class ExampleTest(GamepassTestFramework):
    # Each functional test is a subclass of the GamepassTestFramework class.
    ...
    def custom_method(self):
        ...
        GamepassTestFramework class so other tests can use it."""
