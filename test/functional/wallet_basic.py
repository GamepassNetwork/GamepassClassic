...
class WalletTest(GamepassTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 GPN from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 GPN with subtract fee from amount
        ...
        # Sendmany 10 GPN with subtract fee from amount
