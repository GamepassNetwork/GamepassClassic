...
class AssetTest(GamepassTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("GAMEPASS1", 1000)
        n0.issue("GAMEPASS2", 1000)
        n0.issue("GAMEPASS3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="GAMEPASS*", verbose=False, count=2, start=-2)
        ...
        gamepass_assets = n0.listassets(asset="GAMEPASS*", verbose=False, count=2, start=-2)
        assert_equal(len(gamepass_assets), 2)
        assert_equal(gamepass_assets[0], "GAMEPASS2")
        assert_equal(gamepass_assets[1], "GAMEPASS3")
        self.sync_all()
