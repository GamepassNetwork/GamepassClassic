...
By default, gamepassd will dump mempool on shutdown and
...
class MempoolPersistTest(GamepassTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give gamepassd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent gamepassd from writing mempool.dat to disk. Verify that `savemempool` fails")
