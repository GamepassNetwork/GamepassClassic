...
class BIP66Test(GamepassTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # gamepassd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and gamepassd produces more specific reject
            # reasons.
