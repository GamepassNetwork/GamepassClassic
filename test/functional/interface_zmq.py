...
import os
import struct
from test_framework.test_framework import GamepassTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(GamepassTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that gamepass has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("gamepassd has not been built with zmq enabled.")
