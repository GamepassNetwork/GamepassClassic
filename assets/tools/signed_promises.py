...
# Reads from a Gamepass node - make sure its running
...
def get_rpc_connection():
    ...
    rpc_connection = AuthServiceProxy("http://%s:%s@127.0.0.1:13632"%(rpc_user, rpc_pass))
