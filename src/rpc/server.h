...
#ifndef GAMEPASS_RPCSERVER_H
#define GAMEPASS_RPCSERVER_H
...
/**
 * Gamepass RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isGPN = true);
