...
#include "qt/gamepassamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<GamepassAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_gamepass-qt -platform xcb      # Linux
//     src/qt/test/test_gamepass-qt -platform windows  # Windows
//     src/qt/test/test_gamepass-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = GamepassUnits::formatWithUnit(unit, balance, false, GamepassUnits::separatorAlways);
    ...
    // Amount input
    GamepassAmountField* amountInput = receiveCoinsDialog.findChild<GamepassAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: gamepass:")) != -1);
