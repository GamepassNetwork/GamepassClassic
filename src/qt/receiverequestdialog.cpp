...
#include "config/gamepass-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatGamepassURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + GamepassUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatGamepassURI(info));
}
