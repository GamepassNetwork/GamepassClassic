...
void WalletView::setGamepassGUI(GamepassGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? GamepassGUI::HD44_ENABLED : _walletModel->hdEnabled() ? GamepassGUI::HD_ENABLED : GamepassGUI::HD_DISABLED);
