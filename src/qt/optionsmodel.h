...
#ifndef GAMEPASS_QT_OPTIONSMODEL_H
#define GAMEPASS_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Gamepass client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // GamepassUnits::Unit
...
#endif // GAMEPASS_QT_OPTIONSMODEL_H
