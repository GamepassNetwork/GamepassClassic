...
#ifndef GAMEPASS_QT_SENDASSETSENTRY_H
#define GAMEPASS_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending gamepass.
...
#endif // GAMEPASS_QT_SENDASSETSENTRY_H
