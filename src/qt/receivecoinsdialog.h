...
#ifndef GAMEPASS_QT_RECEIVECOINSDIALOG_H
#define GAMEPASS_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of gamepass */
...
#endif // GAMEPASS_QT_RECEIVECOINSDIALOG_H
