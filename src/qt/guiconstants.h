...
#ifndef GAMEPASS_QT_GUICONSTANTS_H
#define GAMEPASS_QT_GUICONSTANTS_H
...
/* GamepassGUI -- Size of icons in status bar */
...
/* Gamepass dark orange */
#define COLOR_DARK_ORANGE QColor("#f05239")
/* Gamepass light orange */
...
/* Gamepass shadow color - light mode */
...
/* Gamepass label color as a string */
...
#define QAPP_ORG_NAME "Gamepass"
#define QAPP_ORG_DOMAIN "gamepass.network"
#define QAPP_APP_NAME_DEFAULT "Gamepass-Qt"
#define QAPP_APP_NAME_TESTNET "Gamepass-Qt-testnet"

#endif // GAMEPASS_QT_GUICONSTANTS_H
