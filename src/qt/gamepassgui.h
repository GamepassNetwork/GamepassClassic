...
#ifndef GAMEPASS_QT_GAMEPASSGUI_H
#define GAMEPASS_QT_GAMEPASSGUI_H
...
/**
  Gamepass GUI main class. This class represents the main window of the Gamepass UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class GamepassGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit GamepassGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~GamepassGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a gamepass wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // GAMEPASS_QT_GAMEPASSGUI_H
