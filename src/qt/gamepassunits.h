...
#ifndef GAMEPASS_QT_GAMEPASSUNITS_H
#define GAMEPASS_QT_GAMEPASSUNITS_H
...
/** Gamepass unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GamepassUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GamepassUnits(QObject *parent);
...
typedef GamepassUnits::Unit GamepassUnit;

#endif // GAMEPASS_QT_GAMEPASSUNITS_H
