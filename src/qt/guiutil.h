...
#ifndef GAMEPASS_QT_GUIUTIL_H
#define GAMEPASS_QT_GUIUTIL_H
...
/** Utility functions used by the Gamepass Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "gamepass:" URI into recipient object, return true on successful parsing
