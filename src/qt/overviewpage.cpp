...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(GamepassUnits::GPN),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->gamepassBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->gamepassBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(GamepassUnits::formatWithUnit(unit, balance, false, GamepassUnits::separatorAlways));
    ui->labelUnconfirmed->setText(GamepassUnits::formatWithUnit(unit, unconfirmedBalance, false, GamepassUnits::separatorAlways));
    ui->labelImmature->setText(GamepassUnits::formatWithUnit(unit, immatureBalance, false, GamepassUnits::separatorAlways));
    ui->labelTotal->setText(GamepassUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, GamepassUnits::separatorAlways));
    ui->labelWatchAvailable->setText(GamepassUnits::formatWithUnit(unit, watchOnlyBalance, false, GamepassUnits::separatorAlways));
    ui->labelWatchPending->setText(GamepassUnits::formatWithUnit(unit, watchUnconfBalance, false, GamepassUnits::separatorAlways));
    ui->labelWatchImmature->setText(GamepassUnits::formatWithUnit(unit, watchImmatureBalance, false, GamepassUnits::separatorAlways));
    ui->labelWatchTotal->setText(GamepassUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, GamepassUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("GPN")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the GPN balance grid from expanding and looking terrible when asset balance is hidden
