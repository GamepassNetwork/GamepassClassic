...
#ifndef GAMEPASS_CHAINPARAMS_H
#define GAMEPASS_CHAINPARAMS_H
 ...
 * Gamepass system. There are three: the main network on which people trade goods
...
public:
    ...
    const CAmount& ProofOfGameplayAmount() const { return nProofOfGameplayAmount; }
    const CAmount& DevFundAmount() const { return nDevFundAmount; }
    ...
    const std::string& ProofOfGameplayAddress() const { return strProofOfGameplayAddress; }
    const std::string& DevFundAddress() const { return strDevFundAddress; }
    ...
    bool IsBurnAddress(const std::string & p_address) const
    {
        if (
            ...
            || p_address == strProofOfGameplayAddress
            || p_address == strDevFundAddress
        ) {
            return true;
        }
...
protected:
    ...
    CAmount nProofOfGameplayAmount;
    CAmount nDevFundAmount;
    ...
    std::string strProofOfGameplayAddress;
