 ...
 */
#ifndef GAMEPASS_UTIL_H
#define GAMEPASS_UTIL_H
...
extern const char *const GAMEPASS_CONF_FILENAME;
extern const char *const GAMEPASS_PID_FILENAME;
...
{
    std::string s = strprintf("gamepass-%s", name);
