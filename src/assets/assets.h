...
#ifndef GAMEPASS_ASSET_PROTOCOL_H
#define GAMEPASS_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_GAMEPASS_ASSET GPNQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_GAMEPASS_ASSET GPNO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_GAMEPASS_ASSET GPNR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_GAMEPASS_ASSET GPNT
...
#endif //GAMEPASS_ASSET_PROTOCOL_H
