...
#ifndef GAMEPASS_SCRIPT_STANDARD_H
#define GAMEPASS_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_GAMEPASS_ASSET script that carries data
    /** GPN END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a gamepass address
 */
...
/**
 * Generate a Gamepass scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // GAMEPASS_SCRIPT_STANDARD_H
