...
#ifndef GAMEPASS_TEST_SCRIPTNUM10_H
#define GAMEPASS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Gamepass Core 0.10.0, for cross-comparison.
 */
public:
