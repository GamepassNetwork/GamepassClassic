...
BOOST_FIXTURE_TEST_SUITE(netbase_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(netbase_splithost_test)
    {
        ...
        BOOST_CHECK(TestSplitHost("www.gamepass.network", "www.gamepass.network", -1));
        BOOST_CHECK(TestSplitHost("[www.gamepass.network]", "www.gamepass.network", -1));
        BOOST_CHECK(TestSplitHost("www.gamepass.network:80", "www.gamepass.network", 80));
        BOOST_CHECK(TestSplitHost("[www.gamepass.network]:80", "www.gamepass.network", 80));
        BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
        BOOST_CHECK(TestSplitHost("127.0.0.1:5315", "127.0.0.1", 5315));
        BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
        BOOST_CHECK(TestSplitHost("[127.0.0.1]:5315", "127.0.0.1", 5315));
        BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
        BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:5315", "::ffff:127.0.0.1", 5315));
        BOOST_CHECK(TestSplitHost("[::]:5315", "::", 5315));
        BOOST_CHECK(TestSplitHost("::5315", "::5315", -1));
        BOOST_CHECK(TestSplitHost(":5315", "", 5315));
        BOOST_CHECK(TestSplitHost("[]:5315", "", 5315));
    ...
    BOOST_AUTO_TEST_CASE(netbase_lookupnumeric_test)
    {
        ...
        BOOST_CHECK(TestParse("127.0.0.1:5315", "127.0.0.1:5315"));
        BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
        BOOST_CHECK(TestParse("::", "[::]:65535"));
        BOOST_CHECK(TestParse("[::]:5315", "[::]:5315"));
        BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
