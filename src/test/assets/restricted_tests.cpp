...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler GPN tx
        CScript GPNTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut GPNOut(1*COIN, GPNTransfer);
        ...
        mutTxTest1.vout.emplace_back(GPNOut);
        ...
        mutTxTest2.vout.emplace_back(GPNOut);
        ...
        mutTxTest3.vout.emplace_back(GPNOut);
        ...
        mutTxTest4.vout.emplace_back(GPNOut);
        ...
        mutTxTest5.vout.emplace_back(GPNOut);
        ...
        mutTxTest6.vout.emplace_back(GPNOut);
        ...
        mutTxTest7.vout.emplace_back(GPNOut);
        ...
        mutTxTest8.vout.emplace_back(GPNOut);
