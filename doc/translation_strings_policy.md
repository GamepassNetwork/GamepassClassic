...
This document provides guidelines for internationalization of the Gamepass Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gamepass_en.ts` remains unchanged.
