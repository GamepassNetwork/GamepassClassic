...
Below are some notes on how to build Gamepass Core for Windows.
...
way. This will install to `c:\workspace\gamepass`, for example:

    make install DESTDIR=/mnt/c/workspace/gamepass
