Contributing to Gamepass Core
============================

The Gamepass Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to gamepass-qt
  - *Mining* for changes to the mining code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST/ZMQ* for changes to the RPC, REST or ZMQ APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the gamepass unit tests or QA tests
...
The following applies to code changes to the Gamepass Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Gamepass
Network Protocol consensus changes.

Whether a pull request is merged into Gamepass Core rests with the project merge
...
Patches that change Gamepass consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gamepass consensus, it must have been
...
The project leader is the release manager for each Gamepass Core release.
