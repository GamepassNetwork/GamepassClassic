...
rm -rf ~/GamepassCore ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../GamepassCore/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../GamepassCore/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/GamepassCore/temp
cd ~/GamepassCore/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/GamepassCore/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/GamepassCore/depends/SDKs/MacOSX10.11.sdk.tar.gz
